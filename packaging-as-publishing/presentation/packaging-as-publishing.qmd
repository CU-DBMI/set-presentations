...
subtitle: Formalizing your Python Code for Others
format:
  revealjs: 
    theme: simple
    transition: slide
...
__🤷‍♂️ "I'm not convinced. My work is only for _[ internal | quick | throwaway ]_ use so organizing / things for others doesn't matter."__ 
...
- <span style="font-size:.8em">Packaging practices __increase your development velocity__ through reduced time necessary to understand and implement the code (or reuse it in the future)!</span>
- <span style="font-size:.8em">Avoiding common practice and understanding weakens one of our collective superpowers: collaboration.</span>
- <span style="font-size:.8em">How much time will you or others spend on packaging vs providing human impact from the work?</span>
...
- Each file should justify it's existence within the project.
