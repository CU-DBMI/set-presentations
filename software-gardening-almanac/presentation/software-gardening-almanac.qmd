...
- Some philosophy:
  ...
  - Some key considerations from this story:
  ...
  - Some inspiration in the software landscape already for this: git-of-theseus
    - Show git-of-theseus for something common like Pandas

  - Expanding these ideas:
    - Our garden's identity continues alongside _given_ change, effected by the essential and accidental.
    - Making our software gardens more essentially declarative increases continuity through time.
