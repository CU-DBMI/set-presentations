...
We can create "lanterns" through tests to help explore our software and prepare it for use by others.
...
Writing software tests involves distinguishing<br> "production" from "test" code.
...
Programming languages often include built-in testing frameworks (for example, [`unittest`](https://docs.python.org/3/library/unittest.html) in Python).
...
<img src="assets/test-script-to-package.png" style="width:80%;">
...
Unit tests: validate small, isolated parts of your code, like functions or methods.
