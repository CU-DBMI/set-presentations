...
![Figure 3. Chart showing relative memory size for data using various Python libraries.](https://raw.githubusercontent.com/cytomining/CytoTable-benchmarks/init-benchmarks/notebooks/images/mem-read-size.png)
...
![Figure 4. Chart showing read time durations of Pandas and DuckDB with SQLite databases of various sizes.](https://raw.githubusercontent.com/cytomining/CytoTable-benchmarks/init-benchmarks/notebooks/images/join-read-time.png)
...
![Figure 5. Chart showing read time durations for data from various file formats.](https://github.com/cytomining/CytoTable-benchmarks/blob/init-benchmarks/notebooks/images/file-read-time-all.png?raw=true)
...
- The Way Lab: Erik Serrano, Jenna Tomkinson
- The Broad Institute: Shantanu Singh, Beth Cimini
- DBMI Software Engineering Team: Vince Rubinetti (logo design)
