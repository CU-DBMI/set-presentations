...
We are solving significant scalability and replicability challenges with high-dimensional single-cell morphology data (such as those extracted from CellProfiler[1])  by implementing novel and effective capabilities as a modular, portable, and cross-language single-cell data stack[2]:
...
We decrease overall processsing completion time and memory consumption for large amounts of data by leveraging composable data stack elements.

# Empowering the Cytomining Ecosystem

## Orchestration: CytoSnake

_Authors: Erik Serrano, Jenna Tomkinson, Roshan Kern, Vince Rubinetti, Dave Bunten, Gregory P. Way_
...
<div class="container">
  ...
  <div class="text-block" style="text-align:center;"><img src="images/qr_cytosnake.png"/></div>
</div>

## Applied research: NF1 Schwann cell analysis

_Authors: Jenna Tomkinson, Cameron Mattson, Erik Serrano, Gregory P. Way_
...
<div class="container">
  ...
  <div class="text-block" style="text-align:center;"><img src="images/qr_nf1.png"/></div>
</div>

## Applied research: Pyroptosis signature project

_Authors: Michael J. Lippincott, Jenna Tomkinson, Gregory P. Way_

<div style="background-color:#cccccc;">
```{r, echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics("images/pyroptotic_changes.png")
```
</div>
...
<div class="container">
  ...
  <div class="text-block" style="text-align:center;"><img src="images/qr_pyroptosis.png"/></div>
</div>


## Applied research: CFReT project

_Authors: Jenna Tomkinson, Erik Serrano, Gregory P. Way_
...
<div class="container">
  ...
  <div class="text-block" style="text-align:center;"><img src="images/qr_cfret.png"/></div>
</div>
...
- [Broad Institute of MIT and Harvard](https://www.broadinstitute.org/): Shantanu Singh, Beth Cimini, Sam Chen
